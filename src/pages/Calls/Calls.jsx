...
const Calls = () => {
  ...
  useEffect(() => {
    if (userData) {
      getCallsByUserHandle(userData.handle).then((loggedUserCalls) => {
        if (loggedUserCalls) {
  ...
  const handleInputChange = (event) => {
    ...
    if (event.target.value.length) {
      ...
      checkUsersIfBannedLoggedUser(filteredUsers, userData.handle).then(
          ...
          calls.map((call) => {
            return call.incoming ? (
              ...
              >
                ...
                <Spacer />
                <Text fontSize="15px" color="#2E5E17">
                  Incoming Call{" "}
                </Text>
                <Heading
                  fontSize="25px"
              ...
              >
                ...
                <Spacer />
                <Text fontSize="15px" color="#FFBD0A">
                  Outgoing Call{" "}
                </Text>
                <Heading
                  fontSize="25px"
