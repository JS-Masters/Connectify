...
const CreateChatPopUp = () => {
  ...
  useEffect(() => {
    if (users.length > 0) {
      ...
      checkUsersIfBannedLoggedUser(usersFiltered, userData.handle).then(
        setFoundUsers
      );
    }
  }, [searchField, users]);
  ...
  return (
    <Popup
      trigger={
        <Button id="new-chat-button" m="20px">
          NEW CHAT
        </Button>
      }
      modal
        ...
        >
          ...
          <div className="content" style={{ padding: "0 35px" }}>
            ...
            <Button
              ...
              onClick={() => handleCreateChatClick(close)}
              style={{
                position: "absolute",
                bottom: "0",
                marginBottom: "25px",
