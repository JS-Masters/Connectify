...
const CreateChannelPopUp = () => {
  ...
  const handleCreateChannelClick = (close) => {
    if (!channelName) {
      ...
      addChannelToTeam(teamId, channelName, userData.handle).then(
        (newChannelId) => {
  ...
  return (
    <Popup
      trigger={
        <Button id="new-channel-button" marginBottom="50px">
          New Channel
        </Button>
      }
      modal
    ...
    >
      {(close) => (
        ...
        >
          <Button
            id="close-create-channel-button"
            size="sm"
            style={{
              float: "right",
              margin: "10px",
          ...
          <div className="content" style={{ padding: "0 35px" }}>
            ...
            <Button
              ...
              onClick={() => handleCreateChannelClick(close)}
              style={{
                position: "absolute",
                bottom: "0",
                marginBottom: "60px",
